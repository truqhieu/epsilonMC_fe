...
export const apiGetListMedicalRecordbyDoctorId = `/medicalrecord/getListMedicalRecordDoctor`;
export const apiGetListMedicalRecordbyPatientId = `/medicalrecord/getListMedicalRecordPatient/:patientId`;
export const apiGetListMedicalRecordByAppointment = `/medicalrecord/getListMedicalRecordByAppointment/:appointmentId`;
